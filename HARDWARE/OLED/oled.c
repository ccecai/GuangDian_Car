...
extern float pitch,roll,yaw; 								  			 //Å·À­½Ç(×ËÌ¬½Ç)
...
void oled_show(void)
{
//		OLED_ShowChar(25,4,act[2],2);
//	
//		OLED_ShowChar(85,4,act[3],2);
		
		OLED_ShowNumber(85,1,Encoder_Left,2,12);
		
		OLED_ShowNumber(25,1,Encoder_Right,2,12);
		
		OLED_ShowNumber(85,2,Target_A,2,12);
		
		OLED_ShowNumber(25,2,Target_B,2,12);
	
	OLED_ShowNumber(25,3,act_i,2,20);
